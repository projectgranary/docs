...
## Granary 1.1.1 "Cliff" - 2021-08-12
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left">1.1.0 (based on Snowplow v0.15.0)</td>
      <td style="text-align:left">-</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="text-align:left">1.1.0 (based on Server 2.2.3.RELEASE and Skipper 2.1.4.RELEASE)</td>
      <td
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p>Features:</p>
        <ul>
          <li>Add optional filter properties for <code>correlationId</code>, <code>createdAfter</code> and <code>createdBefore</code>
          </li>
          <li>Add optional property <code>outputTopicPartitionsNumber</code>that defines
            the number of partitions of the output topic. Defaults to the number of
            partitions of the original topic.</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p>Fixes:</p>
        <ul>
          <li>Remove Kafka Profile Updater performance impediments by introducing two
            new parameters: <code>kafka.autoCommit</code> and <code>kafka.ackMode</code>.
            Default settings support most reliable (and thus slowest) processing.</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td style="text-align:left">
        <p>Features:</p>
        <ul>
          <li>Add new REST endpoint <code>/profiles/:profileType/:correlationId/grain/:path</code> for
            retrieval of specific grains</li>
          <li>Add new query parameter <code>withHistory</code> for REST endpoint <code>/profiles/:profileType/:correlationId</code>
            <ul>
              <li>controls if only latest grain version are retrieved for profile or all
                versions</li>
            </ul>
          </li>
        </ul>
        <p>Fixes:</p>
        <ul>
          <li>Change fragment filtering so it is executed in database and not in the
            Java code</li>
        </ul>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td style="text-align:left">1.0.1 (based on Presto 0.339)</td>
      <td style="text-align:left">-</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="text-align:left"><b>1.1.2</b>
      </td>
      <td style="text-align:left">
        <p>Fixes:</p>
        <ul>
          <li>Belt Edit: Do not accidentally override changes to &quot;Data In&quot;
            event types. When changing the input event types of a Belt on the edit
            view there was a chance to override these changes by a subsequent change
            to the settings/configuration block.</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td style="text-align:left">
        <p>Fixes:</p>
        <ul>
          <li>Fix wrong indentation of Helm properties</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td style="text-align:left">&lt;b&gt;&lt;/b&gt;<a href="../installation/with-helm/eventstore-reaper.md">Event Store Reaper</a>
      </td>
      <td style="text-align:left"><b>1.1.1</b>
      </td>
      <td style="text-align:left">
    ...
    <tr>
      <td style="text-align:left">&lt;b&gt;&lt;/b&gt;<a href="../installation/with-helm/central-deletion-belt.md">Central Deletion Belt</a>
      </td>
      <td style="text-align:left">1.1.0</td>
      <td style="text-align:left">-</td>
    </tr>
