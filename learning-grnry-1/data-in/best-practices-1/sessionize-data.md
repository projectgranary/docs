...
## About Sessionizing <a href="#about-sessionizing" id="about-sessionizing"></a>
...
{% hint style="info" %}
This section is an addition to [Getting Started](../../../operator-reference/installation/with-helm/harvester-api/getting-started.md), it will not explain in detail how to create a harvester, but only how to register the necessary application and how to add the additional parameters to a standard (non-sessionizing) harvester.&#x20;
{% endhint %}
