...
| ttl                 | Time to life. Allows to modify the grain after a defined duration. Format is [https://en.wikipedia.org/wiki/ISO\_8601#Durations](https://en.wikipedia.org/wiki/ISO\_8601#Durations). | varchar   | `P100Y`   | `NOT NULL` |
